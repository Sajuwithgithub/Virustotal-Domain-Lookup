...
apikey = 'YOUR API Key'  # imp VirusTotal API Key
...
# Read the CSV file
input_file = 'C:\\Users\\{pathfile}\\Downloads\\URLcheck.csv'  # Input CSV file path
output_file = 'C:\\Users\\{Pathfile}\\Downloads\\VTop.csv'  # Output CSV file path
